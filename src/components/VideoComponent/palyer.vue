  ...
  <div id="app">
    <div class="container">
      <div class="__cov-video-container" @mouseenter="mouseEnterVideo"  @mouseleave="mouseLeaveVideo">
        <div class="__cov-video-title" v-show="state.contrlShow">{{title}}</div>
        <video :class="{ 'hide-cursor': !state.contrlShow }" class="__cov-video" :poster="options.poster" webkit-playsinline='true' playsinline='true'>
        ...
        <div class="__cov-contrl-content" transition="fade" v-show="state.contrlShow">
          ...
          <div class="__cov-contrl-vol-box">
            ...
            <div class="__cov-contrl-vol-slider" @click="volSlideClick" @mousedown="volMove">
              <div
                class="__cov-contrl-vol-inner"
                :style="{ 'transform': `translate3d(${volume.pos.current}px, 0, 0)`}"
              ></div>
